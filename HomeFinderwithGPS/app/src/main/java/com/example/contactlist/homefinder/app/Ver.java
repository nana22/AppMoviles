...
public class Ver extends Activity implements FragVer.Communicator{
    ...
    public void respond(int index) {
        ...
        if(detalles !=null && detalles.isVisible()) {
            detalles.changeData(bodyPropiedades.get(index), bodyDueños.get(index), publicacion.getPropiedades().get(index).getLatitud(), publicacion.getPropiedades().get(index).getLongitud());
        }
        else{
            ...
            intent.putExtra("latitud",publicacion.getPropiedades().get(index).getLatitud());
            intent.putExtra("longitud",publicacion.getPropiedades().get(index).getLongitud());
