...
public class Consultas {
    ...
    public List<Propiedad> consultarPropiedades(){
        String query = consultar("https://homefinder-c9-mobilebackend.c9.io/verPropiedades");
    ...
    public List<Persona> consultarDueños(){
        String query = consultar("https://homefinder-c9-mobilebackend.c9.io/verDuenios");
    ...
    public Persona consultarDueñoXPropiedad(String pFbDueño) {
        String query = consultar("https://homefinder-c9-mobilebackend.c9.io/verDueniosXPropiedad/" + pFbDueño);
    ...
    public List<Propiedad> consultarPropiedadesXDuenio(String pFacebook) {
        String query = consultar("https://homefinder-c9-mobilebackend.c9.io/verPropiedadesXDuenio/" + pFacebook);
        List<Propiedad> propiedades = null;
        if (!query.equals("")) {
            propiedades = new Gson().fromJson(query, new TypeToken<List<Propiedad>>(){}.getType());
        }
    ...
    public void submitPropiedad(Propiedad pPropiedad) throws IOException {
        uri = "https://homefinder-c9-mobilebackend.c9.io/addPropiedad";
    ...
    public void submitDueño(Persona pDueño) throws IOException {
        uri = "https://homefinder-c9-mobilebackend.c9.io/addPerson";
